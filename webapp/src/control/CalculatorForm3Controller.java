...
@Component("/kidney/cal_form3.do")
public class CalculatorForm3Controller implements Controller, DataBinding {

	private CalculatorDao calculatorDao;

	public CalculatorForm3Controller setCalculatorDao(CalculatorDao calculatorDao) {
	...
	public Object[] getDataBinders() {
		return new Object[] { "kind", Integer.class, "page", Integer.class, "page2", Integer.class };
	}
