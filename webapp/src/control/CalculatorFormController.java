...
@Component("/kidney/cal_form.do")
public class CalculatorFormController implements Controller, DataBinding {

	private CalculatorDao calculatorDao;

	public CalculatorFormController setCalculatorDao(CalculatorDao calculatorDao) {
...
//				Integer kind = (Integer) model.get("kind");
				...
				int cnt = paging.getDisplayRow();
				//DB 총 갯수
				int count = calculatorDao.getAllCount();
		
				paging.setTotalCount(count);
				paging.setPage(page);
				

				ArrayList<Food> foodList = calculatorDao.list(page, cnt);
