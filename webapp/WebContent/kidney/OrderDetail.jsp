...
<body>
	...
	<form method="post" name="form4">
		...
		<jsp:include page="frame/Nav4.jsp" />
		...
		<tr>
			...
			<tr>
			<td  style="background: #FFF5EE">예약 인원</td> <td> ${order.quantity1 + order.quantity2 } 명</td>
			</tr>
	...
	<p></p>
	<center>
	<input type="button" value="확인" onclick="location.href='orderpage.do?page=${page}'" style="width:150px; height:50px;">
	</center>
	</form>
